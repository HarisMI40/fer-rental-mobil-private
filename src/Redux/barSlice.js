...
export const chartOrderReport = createAsyncThunk("admin/getOrderReport", 
...
const chartbarSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(chartOrderReport.fulfilled, (state, actions)=>{state.chartReport=actions.payload})
        builder.addCase(chartOrderReport.rejected, (state, actions)=>{state.chartReport=null})
